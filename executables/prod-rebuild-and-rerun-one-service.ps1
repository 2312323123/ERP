...
docker-compose -f ../docker-compose.yml -f ../docker-compose.prod.yml rm -svf $ServiceName
docker-compose -f ../docker-compose.yml -f ../docker-compose.prod.yml build $ServiceName
docker-compose -f ../docker-compose.yml -f ../docker-compose.prod.yml up -d $ServiceName
